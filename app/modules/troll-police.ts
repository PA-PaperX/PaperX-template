...
const rules: PoliceRule[] = [
    ...
    },
    {
        ...
        emoji: '👴',
        message: '"นี่มันปี 2026 แล้วนะพี่! จะเขียน Vue 2 ไปถึงไหน?"\nไปใช้ <script setup> ซะ ไอ้ไก่!'
    },
    {
    ...
    },
    {
        ...
        emoji: '⛏️',
        message: '"jQuery ในปี 2026!? พี่ขุดไซต์โบราณมาหรอ?"\nทิ้งเถอะพี่ Vue มี reactivity system ให้ใช้แล้ว\nไม่ต้อง $(\'.class\').hide() อีกต่อไป!'
    },
    {
        pattern: /eval\s*\(/,
        title: 'SECURITY BREACH',
        emoji: '💀',
        message: '"eval() !!? จะเปิดประตูนรกหรอ!?"\neval = evil! มีช่องโหว่ XSS ร้ายแรง!\nเอาออกเดี๋ยวนี้ก่อนจะโดน hack!'
    },
    {
        pattern: /innerHTML\s*=/,
    ...
    },
    {
        ...
        title: 'CRIME SCENE',
        emoji: '🚨',
        message: '"@ts-ignore!? หนีปัญหาหรอ!?"\nอย่าปิดตา TypeScript แล้วบอกว่าไม่มี bug!\nแก้ type ให้ถูก ไม่ใช่บอกให้ TS หุบปาก!'
    },
    {
        pattern: /@ts-nocheck/,
        title: 'TOTAL ANARCHY',
